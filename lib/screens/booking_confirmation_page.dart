...
//     // Optionally, you can use a package like `url_launcher` to open the PDF file for the user
//     // Or use a file manager to navigate to the file location.
//   }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              _buildInfoCard('Number of People', numberOfPeople),
              const SizedBox(height: 32), // Add extra space for buttons
              ElevatedButton(
                onPressed: () => _navigateToPayment(context),
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color.fromARGB(255, 176, 174, 196),
