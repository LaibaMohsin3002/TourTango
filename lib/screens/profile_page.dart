        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildProfileField(
                label: "Name",
                value: isEditing ? nameController.text : name,
                icon: Icons.person,
              ...
              _buildProfileField(
                label: "Email",
                value: isEditing ? emailController.text : email,
                icon: Icons.email,
                isReadOnly: !isEditing,
              ),
              const SizedBox(height: 16),
              ...
              _buildProfileField(
                label: "Phone Number",
                value: isEditing ? phoneController.text : phone,
                icon: Icons.phone,
                isReadOnly: !isEditing,
              ),
              const SizedBox(height: 16),
              ...
              if (isEditing) ...[
                ...
                ElevatedButton(
                  onPressed: () {
                    setState(() {
                      // Save changes (this example just updates the variables)
